...
import { TableLayout } from "@/components/dashboard/table-layout"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Configure table layout and manage availability</p>
            </div>
            <Button
              variant="outline"
          ...
          <TableLayout restaurant={restaurant} onTableUpdate={loadData} />
        </div>
      </main>
    </div>
  )
